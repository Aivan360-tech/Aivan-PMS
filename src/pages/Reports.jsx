import { MdOutlineAssessment, MdOutlineConstruction } from 'react-icons/md'
  ...
  return (
    <div className="card flex flex-col items-center justify-center gap-4 px-6 py-24 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-navy-50">
        <MdOutlineAssessment className="h-8 w-8 text-navy-400" />
      </div>
      <div>
        <h2 className="text-lg font-bold text-navy-900">Reports</h2>
        <p className="mx-auto mt-1.5 max-w-md text-sm text-navy-400">
          Detailed occupancy, allocation, and utilization reports will be available here in a
          future release.
        </p>
      </div>
